...
const StaffManagement = () => {
  ...
  const handleDelete = record => {
    Modal.confirm({
      title: t('staffManagement.table.actions.inactiveStaff.modal.title'),
      content: t('staffManagement.table.actions.inactiveStaff.modal.content'),
      okText: t('staffManagement.table.actions.inactiveStaff.modal.confirm'),
      okType: 'danger',
      cancelText: t('staffManagement.table.actions.inactiveStaff.modal.cancel'),
      onOk() {
        setUsers(users.filter(user => user.id !== record.id))
        message.success(
          t('staffManagement.table.actions.inactiveStaff.modal.success')
        )
      },
    })
  }
  ...
  const moreActions = record => ({
    items: [
      {
        key: 'view',
        label: t('staffManagement.table.actions.viewDetails'),
        icon: <EyeOutlined />,
        onClick: () => handleView(record),
      },
      {
        key: 'edit',
        label: t('staffManagement.table.actions.editStaff'),
        icon: <EditOutlined />,
      ...
      {
        key: 'inactive',
        label: t('staffManagement.table.actions.inactiveStaff.modal.title'),
        icon: <BlockOutlined />,
        danger: true,
  ...
  const columns = [
    {
      title: t('staffManagement.table.user'),
      dataIndex: 'fullName',
      key: 'fullName',
      render: (text, record) => (
    ...
    },
    {
      ...
      key: 'role',
      render: role => (
        <Tag color={role === 'Teacher' ? 'blue' : 'purple'}>
          {role === 'Teacher' ? t('role.teacher') : t('role.counselor')}
        </Tag>
      ),
      filters: [
