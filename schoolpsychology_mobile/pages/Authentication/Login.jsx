  ...
  return (
    <View style={styles.container}>
      <View style={styles.innerContainer}>
        ...
        <Text style={styles.appName}><Text style={styles.appNameBold}>Mindful</Text>Care</Text>
...
const styles = StyleSheet.create({
  ...
  loadingOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.15)', justifyContent: 'center', alignItems: 'center' },
});
